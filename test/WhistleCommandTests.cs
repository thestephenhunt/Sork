...
public sealed class WhistleCommandTests
{
    ...
    public void Execute_ShouldOutputMessage()
    {
        ...
        Assert.AreEqual(" whistle loudly.", io.Outputs.Last());
    }

    [TestMethod]
    public void Execute_ShouldReturnTrue_WhenCapitalizedInputIsProvided()
    {
        // Arrange
    ...
    [TestMethod]
    public void Execute_ShouldReturnTrue_WhenLowercaseInputIsProvided()
    {
        // Arrange
        var command = new WhistleCommand(new UserInputOutput());
